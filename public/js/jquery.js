!(function (e, t) {
  ...
  var b = (function (e) {
    ...
    try {
      D.apply((E = H.call(k.childNodes)), k.childNodes),
      ...
      if (
        ...
        if (11 !== T && (h = K.exec(e)))
          if ((r = h[1])) {
            ...
            } else if (x && (d = x.getElementById(r)) && b(t, d) && d.id === r)
              return i.push(d), i;
          } else {
      ...
      var n = t.length > 0,
        ...
        r = function (r, s, a, l, c) {
          ...
          if (((m += y), n && y !== m)) {
            ...
            D.apply(l, w),
              c && !r && w.length > 0 && m + t.length > 1 && oe.uniqueSort(l);
          }
          return c && ((x = C), (d = k)), b;
        };
      return n ? se(r) : r;
  ...
  (f.filter = function (e, t, n) {
    ...
    f.fn.extend({
      ...
      is: function (e) {
        return !!S(this, "string" == typeof e && x.test(e) ? f(e) : e || [], !1)
          .length;
      },
    });
  var _,
      ...
      function (e, t) {
        f.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (j[e] || (o = f.uniqueSort(o)), A.test(e) && (o = o.reverse())),
            this.pushStack(o)
          );
        };
      }
        ...
        c = function (e, n, i) {
          return function (r) {
            (n[e] = this),
              ...
              i === t ? d.notifyWith(n, i) : --l || d.resolveWith(n, i);
          };
        };
      if (a > 1)
  ...
  function W(e, t, i, o) {
    if (P(e)) {
      ...
      if (
        ...
        return (
          c || (c = l ? (e[a] = n.pop() || f.guid++) : a),
          d[c] || (d[c] = l ? {} : { toJSON: f.noop }),
          ("object" != typeof t && "function" != typeof t) ||
            (o
              ? (d[c] = f.extend(d[c], t))
              : (d[c].data = f.extend(d[c].data, t))),
          (s = d[c]),
      ...
      if (s[a]) {
        if (t && (i = n ? s[a] : s[a].data)) {
          f.isArray(t)
            ...
            : t in i
            ? (t = [t])
            : (t = (t = f.camelCase(t)) in i ? [t] : t.split(" ")),
            (o = t.length);
          for (; o--; ) delete i[t[o]];
  ...
  function ae(e, t, n, i, o) {
        ...
        if ("object" === f.type(s)) f.merge(g, s.nodeType ? [s] : s);
          ...
          for (
            l = l || v.appendChild(t.createElement("div")),
              d = (G.exec(s) || ["", ""])[1].toLowerCase(),
              p = te[d] || te._default,
              l.innerHTML = p[1] + f.htmlPrefilter(s) + p[2],
              r = p[0];
            r--;
          ...
          if (
            (!u.leadingWhitespace &&
              K.test(s) &&
              g.push(t.createTextNode(K.exec(s)[0])),
            !u.tbody)
          )
            for (
              r =
    ...
    for (
      l && v.removeChild(l),
        u.appendChecked || f.grep(ne(g, "input"), se),
        m = 0;
      (s = g[m++]);
  ...
  !(function () {
    ...
    for (t in { submit: !0, change: !0, focusin: !0 })
      (n = "on" + t),
        (u[t] = n in e) ||
          (o.setAttribute(n, "t"), (u[t] = !1 === o.attributes[n].expando));
    o = null;
  })();
  ...
  (f.event = {
    ...
    trigger: function (t, n, o, r) {
      ...
      if (
        ...
        3 !== o.nodeType &&
          ...
          ((t = t[f.expando]
            ? t
            : new f.Event(g, "object" == typeof t && t)).isTrigger = r ? 2 : 3),
          (t.namespace = m.join(".")),
          ...
          (u = f.event.special[g] || {}),
          r || !u.trigger || !1 !== u.trigger.apply(o, n)))
      ) {
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[r] = a =
            ce.test(r) ? this.mouseHooks : de.test(r) ? this.keyHooks : {}),
    ...
    mouseHooks: {
      ...
      filter: function (e, t) {
        ...
        return (
          null == e.pageX &&
            null != t.clientX &&
            ((r = (o = e.target.ownerDocument || i).documentElement),
            (n = o.body),
            (e.pageX =
              t.clientX +
  ...
  function Ee(e, t, n, i) {
    ...
    if (
      h &&
      ((o = (c = ae(t, e[0].ownerDocument, !1, e, i)).firstChild),
      ...
      for (a = (l = f.map(ne(c, "script"), _e)).length; p < h; p++)
        (s = c),
          p !== v &&
            ((s = f.clone(s, !0, !0)), a && f.merge(l, ne(s, "script"))),
          n.call(e[p], s, p);
      if (a)
        for (d = l[l.length - 1].ownerDocument, f.map(l, $e), p = 0; p < a; p++)
          (s = l[p]),
            J.test(s.type || "") &&
    ...
    clone: function (e, t, n) {
      ...
      if (
        (u.html5Clone || f.isXMLDoc(e) || !ye.test("<" + e.nodeName + ">")
          ? (r = e.cloneNode(!0))
          : ((Ce.innerHTML = e.outerHTML), Ce.removeChild((r = Ce.firstChild))),
        !(
      ...
      if (t)
        if (n)
          for (a = a || ne(e), i = i || ne(r), s = 0; null != (o = a[s]); s++)
            Ae(o, i[s]);
        else Ae(e, r);
      return (
        (i = ne(r, "script")).length > 0 && ie(i, !l && ne(e, "script")),
        (i = a = o = null),
        r
      );
    },
    ...
    return (
      n ||
        (("none" !== (n = He(e, t)) && n) ||
          ((t = (
            (Le = (
              Le || f("<iframe frameborder='0' width='0' height='0'/>")
            ).appendTo(t.documentElement))[0].contentWindow ||
            Le[0].contentDocument
          ).document).write(),
          t.close(),
          (n = He(e, t)),
          Le.detach()),
    ...
    function c() {
      ...
      p.appendChild(l),
        ...
        e.getComputedStyle &&
          ...
          ((c = d.appendChild(i.createElement("div"))).style.cssText =
            d.style.cssText =
              "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0"),
          (c.style.marginRight = c.style.width = "0"),
          (d.style.width = "1px"),
          (s = !parseFloat((e.getComputedStyle(c) || {}).marginRight)),
          d.removeChild(c)),
        ...
        (r = 0 === d.getClientRects().length) &&
          ...
          ((c = d.getElementsByTagName("td"))[0].style.cssText =
      ...
      (i = e[s]).style &&
        ...
        t
          ? (r[s] || "none" !== n || (i.style.display = ""),
            "" === i.style.display &&
              U(i) &&
              (r[s] = f._data(i, "olddisplay", Oe(i.nodeName))))
          : ((o = U(i)),
            ((n && "none" !== n) || !o) &&
  ...
  function tt(e, t, n, i, o) {
    for (
      ...
      "margin" === n && (s += f.css(e, n + X[r], !0, o)),
        i
          ? ("content" === n && (s -= f.css(e, "padding" + X[r], !0, o)),
            "margin" !== n && (s -= f.css(e, "border" + X[r] + "Width", !0, o)))
          : ((s += f.css(e, "padding" + X[r], !0, o)),
            "padding" !== n &&
              (s += f.css(e, "border" + X[r] + "Width", !0, o)));
    return s;
  }
  function nt(e, t, n) {
    var i = !0,
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          l = e.style;
        if (
          ((t = f.cssProps[a] || (f.cssProps[a] = Ke(a) || a)),
  ...
  function ut(e, t, n) {
    ...
    for (
      ...
      if ((i = ut.prefilters[r].call(d, e, c, d.opts)))
        return (
          f.isFunction(i.stop) &&
            (f._queueHooks(d.elem, d.opts.queue).stop = f.proxy(i.stop, i)),
          i
        );
    return (
      f.map(c, ct, d),
      f.isFunction(d.opts.start) && d.opts.start.call(e, d),
      f.fx.timer(f.extend(l, { elem: e, anim: d, queue: d.opts.queue })),
      d
  ...
  (f.Animation = f.extend(ut, {
    ...
    (function () {
      ...
      (n = i.createElement("div")).setAttribute("className", "t"),
        ...
        (u.getSetAttribute = "t" !== n.className),
        (u.style = /top/.test(e.getAttribute("style"))),
        (u.hrefNormalized = "/a" === e.getAttribute("href")),
        (u.checkOn = !!t.value),
        (u.optSelected = r.selected),
        (u.enctype = !!i.createElement("form").enctype),
        (o.disabled = !0),
        (u.optDisabled = !r.disabled),
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== r && 8 !== r && 2 !== r)
          return void 0 === e.getAttribute
            ...
            : ((1 === r && f.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (o = f.attrHooks[t] || (f.expr.match.bool.test(t) ? vt : ht))),
              void 0 !== n
                ? null === n
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            var t, i, o, r;
            if ("string" === n)
              for (i = 0, o = f(this), r = e.match(D) || []; (t = r[i++]); )
  ...
  f.extend({
    ...
    ajax: function (t, n) {
      ...
      (u.hasContent = !Nt.test(u.type)),
      (r = u.url),
      u.hasContent ||
        (u.data &&
          ((r = u.url += (_t.test(r) ? "&" : "?") + u.data), delete u.data),
        !1 === u.cache &&
          (u.url = jt.test(r)
            ? r.replace(jt, "$1_=" + St++)
            : r + (_t.test(r) ? "&" : "?") + "_=" + St++)),
      ...
      ((u.data && u.hasContent && !1 !== u.contentType) || n.contentType) &&
      ...
      function T(t, n, i, o) {
        ...
        2 !== w &&
          ...
          c
            ? (u.ifModified &&
                ((T = x.getResponseHeader("Last-Modified")) &&
                  (f.lastModified[r] = T),
                (T = x.getResponseHeader("etag")) && (f.etag[r] = T)),
              204 === t || "HEAD" === u.type
                ? (C = "nocontent")
                : 304 === t
                ? (C = "notmodified")
          ...
          (x.status = t),
          (x.statusText = (n || C) + ""),
          c ? v.resolveWith(p, [y, C, x]) : v.rejectWith(p, [x, C, b]),
          x.statusCode(m),
          (m = void 0),
          l && h.trigger(c ? "ajaxSuccess" : "ajaxError", [x, u, c ? y : b]),
          g.fireWith(p, [x, C]),
          l &&
            (h.trigger("ajaxComplete", [x, u]),
    ...
    (f.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === d && (e.style.position = "relative"),
          ...
          (r = f.css(e, "top")),
          (l = f.css(e, "left")),
          ("absolute" === d || "fixed" === d) && f.inArray("auto", [r, l]) > -1
  ...
  (function (e, t) {
    ...
    var e = {
      ...
      o = function () {
        ...
        (e.innerHTML =
          "<p>x</p><style>.fluidvids{width:100%;position:relative;}.fluidvids iframe{position:absolute;top:0px;left:0px;width:100%;height:100%;}</style>"),
          t.appendChild(e.childNodes[1]);
      };
    return (
      (e.apply = function () {
        for (
  ...
  (function (e, t, n) {
    ...
    (i.prototype.init = function () {
      var n,
        ...
        h = this.settings;
      if (
        (h.duplicate ? (o.mobileNav = r.clone()) : (o.mobileNav = r),
        h.removeIds &&
          (o.mobileNav.removeAttr("id"),
          o.mobileNav.find("*").each(function (t, n) {
            e(n).removeAttr("id");
          })),
        h.removeClasses &&
        ...
        o.mobileNav.attr("class", s + "_nav"),
        (i = e('<div class="' + s + '_menu"></div>')),
        "" !== h.brand)
      ) {
      ...
      (o.btn = e(
        ...
        e(i).append(o.btn),
        "" !== h.appendTo ? e(h.appendTo).append(i) : e(h.prependTo).prepend(i),
      ...
      e(g).each(function () {
        ...
        e(o.btn).keydown(function (t) {
          ...
          switch (n.keyCode) {
            ...
            case a:
              t.preventDefault(),
                (n.keyCode === a && e(o.btn).hasClass(s + "_open")) ||
                  o._menuToggle(),
                e(o.btn).next().find('[role="menuitem"]').first().focus();
          }
        }),
          ...
          switch ((t || event).keyCode) {
            ...
            case u:
              t.preventDefault(),
                e(t.target)
                  .parent()
                  .hasClass(s + "_collapsed") && o._itemClick(e(t.target)),
            ...
            case c:
              if (
                ...
                e(t.target)
                  .parent()
                  .parent()
                  .hasClass(s + "_nav") && (o._menuToggle(), e(o.btn).focus());
              break;
            case d:
      ...
      (i.prototype._menuToggle = function (e) {
        ...
        n.hasClass(s + "_collapsed")
          ...
          t._visibilityToggle(i, n.parent(), !0, n);
      }),
      (i.prototype._itemClick = function (e) {
        var t = this,
          ...
          i = e.data("menu");
        i ||
          (((i = {}).arrow = e.children("." + s + "_arrow")),
          (i.ul = e.next("ul")),
          (i.parent = e.parent()),
          i.parent.hasClass(s + "_parent-link") &&
            ((i.parent = e.parent().parent()), (i.ul = e.parent().next("ul"))),
          e.data("menu", i)),
          i.parent.hasClass(s + "_collapsed")
            ? (i.arrow.html(n.openedSymbol),
              i.parent.removeClass(s + "_collapsed"),
              i.parent.addClass(s + "_open"),
              i.parent.addClass(s + "_animating"),
              t._visibilityToggle(i.ul, i.parent, !0, e))
            : (i.arrow.html(n.closedSymbol),
              i.parent.addClass(s + "_collapsed"),
              i.parent.removeClass(s + "_open"),
              i.parent.addClass(s + "_animating"),
              t._visibilityToggle(i.ul, i.parent, !0, e));
      }),
  ...
  jQuery(document).ready(function (e) {
    ...
    e(window).scroll(function () {
      ...
      e(".jl_w_slider").slick({
        ...
        adaptiveHeight: !0,
        prevArrow:
          '<div class="jl-slider-prev jl_es_pre"><i class="jli-left-chevron"></i></div>',
        nextArrow:
          '<div class="jl-slider-next jl_es_next"><i class="jli-right-chevron"></i></div>',
        slidesToShow: 1,
        slidesToScroll: 1,
      }),
      e(".jl-s-slider").slick({
      ...
      e(".jl_day_night .jl_moon").on("click", function () {
        e(".jl_day_night").addClass("jl_night_en"),
          e(".jl_day_night").removeClass("jl_day_en"),
          e(".jl_en_day_night").addClass("options_dark_skin"),
          e(".mobile_nav_class").addClass("wp-night-mode-on");
      }),
      e(".jl_day_night .jl_sun").on("click", function () {
        e(".jl_day_night").addClass("jl_day_en"),
          e(".jl_day_night").removeClass("jl_night_en"),
          e(".jl_en_day_night").removeClass("options_dark_skin"),
          e(".mobile_nav_class").removeClass("wp-night-mode-on");
      }),
      e(".menu_mobile_icons, .mobile_menu_overlay").on("click", function () {
        e("#content_nav").toggleClass("jl_mobile_nav_open"),
          e(".mobile_menu_overlay").toggleClass("mobile_menu_active"),
      ...
      e("#mobile_menu_slide .arrow_down i").on("click", function () {
        ...
        return (
          e(this).toggleClass("jli-down-chevron").toggleClass("jli-up-chevron"),
          t.hasClass("menu-active-class")
            ? t.removeClass("menu-active-class")
            : t.addClass("menu-active-class"),
          !1
        );
      }),
      ...
      e(".single_post_share_icons").on("click", function () {
        e(".single_post_share_wrapper").toggleClass("share_single_active"),
          e(".mobile_nav_class").toggleClass("active_mobile_nav_class");
      }),
      e(".search_form_menu_click").on("click", function (t) {
        t.preventDefault(),
          e(".search_form_menu").toggle(),
    ...
    n.each(function () {
      var t = e(this);
      t.next().children(".tab-content").stop(!0, !0).hide().first().show(),
        t.children("li").first().addClass("active").stop(!0, !0).show();
    }),
      o.on("click", function (t) {
        var n = e(this);
        n.siblings().removeClass("active").end().addClass("active"),
          n
            .parent()
            .next()
            ...
            .stop(!0, !0)
            .hide()
            .siblings(n.find("a").attr("href"))
            .fadeIn(),
          t.preventDefault();
      }),
      jQuery(window).scroll(function () {
        e(window).scrollTop() >= 100
          ? (e(".jl_large_menu_logo").addClass("jl_custom_height_small"),
            e(".options_dark_header").addClass("dark_header_menu"))
          : (e(".jl_large_menu_logo").removeClass("jl_custom_height_small"),
            e(".options_dark_header").removeClass("dark_header_menu")),
    ...
    fluidvids.init({
      ...
      e(".quantity .jlb-btn").on("click", function (t) {
        ...
        var n = e(this),
          ...
          a = parseInt(o.val()),
          l = parseInt(o.val());
        o.attr("step") && (i = parseInt(o.attr("step"))),
          o.attr("min") && (r = parseInt(o.attr("min"))),
          o.attr("max") && (s = parseInt(o.attr("max"))),
          n.hasClass("up")
            ? (l = a < s ? a + i : s)
            : n.hasClass("down") && (l = a > r ? a - i : r),
          o.attr("disabled") || o.val(l).change();
      });
  });
